...
import { LeaderboardMapper, type FirebaseLeaderboardEntry } from './LeaderboardMapper'
import type { LeaderboardScore } from '@/features/games/yams/application/repositories/ILeaderboardRepository'

const fakeEntry: FirebaseLeaderboardEntry = {
  playerName: 'Alice',
  score: 300,
  yahtzeeBonus: 1,
...
const fakeEntries: FirebaseLeaderboardEntry[] = [
  { playerName: 'Alice', score: 300, yahtzeeBonus: 1, timestamp: '2025-01-15T10:00:00.000Z' },
  { playerName: 'Bob',   score: 250, yahtzeeBonus: 0, timestamp: '2025-02-20T08:30:00.000Z' },
  { playerName: 'Carol', score: 200, yahtzeeBonus: 2, timestamp: '2025-03-10T14:00:00.000Z' },
]
...
describe('Infrastructure, unit testing: LeaderboardMapper', () => {
  describe('1) toDomain', () => {
    ...
    it('1.5) should ignore optional createdAt field', () => {
      const entryWithCreatedAt: FirebaseLeaderboardEntry = {
        ...fakeEntry,
