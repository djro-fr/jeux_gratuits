...
interface CategoriesScoredBottomProps {
  scoreBoard: YamsScoreBoard
}

export const CategoriesScoredBottom = ({scoreBoard} : CategoriesScoredBottomProps ) => {
  ...
  return (
    <div id="score-check-bottom"  className="score-check flex flex-1 justify-center items-center">
